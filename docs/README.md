# Iron Rails Documentation

Welcome to the central documentation hub for the Iron Rails project. This directory contains the Game Design Document (GDD), in-depth technical analysis, and the framework for future project initiatives.
...
- **[README.md](./initiatives/README.md)**: An explanation of the initiative system.
- **[template.md](./initiatives/template.md)**: The template for creating new initiative documents.
